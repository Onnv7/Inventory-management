...
function createImport() {
    ...
    url = contextPath + "invoice/import/create/" + idWarehouse;
...
function updateImport(e) {
    url = contextPath + `invoice/import/update/${e.target.id}`;
    jsonData = {
        title: title.val(),
        date: date.val(),
        note: note.val(),
...
function updateInvoiceDetail(e) {
    url = contextPath + `invoice/import/details/update/${e.target.id}`;
    jsonData = {
        quantity: quantityDetail.val(),
        note: noteDetail.val(),
        product: {
...
async function openModal(e) {
    ...
    url = contextPath + "invoice/import/details/" + id;
    let htmlToAppend;
...
async function getAllImportByWarehouseId() {
    url = contextPath + "invoice/import/warehouse/" + warehouse.val();
